				...
				$this->add_control(
					...
					[
						...
						'options' => [
							...
							'icon-scale' => esc_html__( 'Icon Scale', 'themesflat-elementor' ),
						]
					]
				);		
	    ...
	    // Start Content Style 
			...
			$this->add_control(
				...
				[
					...
					'default' => '#565872',
					'selectors' => [
						'{{WRAPPER}} .tficonbox .content .description, {{WRAPPER}} .tficonbox .content .description a' => 'color: {{VALUE}};',
					]
				]
			);		    
				...
				$this->start_controls_tab( 'button_style_hover_tab',
					...
					$this->add_control( 
						...
						[
							...
							'default' => '',
							'selectors' => [
								'{{WRAPPER}} .tficonbox .tf-button:not(.btn):hover, {{WRAPPER}} .tficonbox .tf-button.btn:before' => 'background-color: {{VALUE}}',
							],
						]
					);
