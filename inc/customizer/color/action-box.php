...
$wp_customize->add_control(
    new WP_Customize_Image_Control(
        ...
        'action_box_background_image',
        array(
           'label'          => esc_html__( 'Upload Your Background Image', 'grower' ),
           'type'           => 'image',
...
$wp_customize->add_control( 
    new themesflat_ColorOverlay(
        ...
        'action_box_background_color',
        array(
            'label'         => esc_html__('Action Box Backgound', 'grower'),
            'section'       => 'color_action_box',
...
$wp_customize->add_control( 
    new themesflat_ColorOverlay(
        ...
        'action_box_heading_color',
        array(
            'label'         => esc_html__('Action Box Heading Color', 'grower'),
            'section'       => 'color_action_box',
...
$wp_customize->add_control( 
    new themesflat_ColorOverlay(
        ...
        'action_box_text_color',
        array(
            'label'         => esc_html__('Action Box Text Color', 'grower'),
            'section'       => 'color_action_box',
...
$wp_customize->add_control( 
    new themesflat_ColorOverlay(
        ...
        'action_box_button_text_color',
        array(
            'label'         => esc_html__('Action Box Button Text Color', 'grower'),
            'section'       => 'color_action_box',
...
$wp_customize->add_control( 
    new themesflat_ColorOverlay(
        ...
        'action_box_button_background_color',
        array(
            'label'         => esc_html__('Action Box Button Background Color', 'grower'),
            'section'       => 'color_action_box',
