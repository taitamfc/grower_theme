...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
        ...
        array(
            'type'      => 'checkbox',
            'label'     => esc_html__('Action Box ( OFF | ON )', 'grower'),
...
$wp_customize->add_control(
    ...
    array(
        'type'      =>  'textarea',
        'label'     =>  esc_html__('Heading Action Box', 'grower'),
        'section'   =>  'section_action_box',
        'priority'  =>  3,
        'active_callback' => function() use ( $wp_customize ) {
            return 1 === $wp_customize->get_setting( 'show_action_box' )->value();
...
$wp_customize->add_control(
    ...
    array(
        'type'      =>  'textarea',
        'label'     =>  esc_html__('Text Action Box', 'grower'),
        'section'   =>  'section_action_box',
        'priority'  =>  4,
        'active_callback' => function() use ( $wp_customize ) {
...
$wp_customize->add_control(
    ...
    array(
        'type'      =>  'textarea',
        'section'   =>  'section_action_box',
        'label'     =>  esc_html__('Content Right', 'grower'),
        'description' => esc_html__('shorcode or button link ex: [mc4wp_form id="237"] or <a href="#" class="themesflat-button">Read More</a>', 'grower'),
        'priority'  => 5,
        'active_callback' => function() use ( $wp_customize ) {
            return 1 === $wp_customize->get_setting( 'show_action_box' )->value();
        },
