...
final class ThemesFlat_Addon_For_Elementor_Carenow
{
    ...
    public function init()
    {
        ...
        add_action('elementor/element/section/section_background/before_section_end', [$this, 'tf_add_section_parallax']);
    ...
    public function init_widgets()
    {
        ...
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new \TF_Google_Maps_Widget());
        ...
        require_once(__DIR__ . '/widgets/widget-services.php');
        ...
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new \TFPieChart_Widget());
        ...
        // \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \TFCountdown_Widget() );
        ...
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new \TFProgressBars_Widget());

        // require_once( __DIR__ . '/widgets/widget-step.php' );
        // \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \TFStep_Widget() );
        ...
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new \TFDoctor_Widget());

        require_once(__DIR__ . '/widgets/widget-portfolio.php');
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new \TFPortfolio_Widget());

        require_once(__DIR__ . '/widgets/widget-navmenu.php');
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new \TFNavMenu_Widget());

        // require_once( __DIR__ . '/widgets/widget-raindrop.php' );
        // \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \TFRainDrop_Widget() );       

        // if ( class_exists( 'woocommerce' ) ) { 
        //     require_once( __DIR__ . '/widgets/widget-woo-category.php' );
        //     \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \TFWooCategory_Widget() );
        //     require_once( __DIR__ . '/widgets/widget-woo-products.php' );
        //     \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \TFWooProducts_Widget() );
        //     require_once( __DIR__ . '/widgets/widget-woo-products-banner.php' );
        //     \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \TFWooProductsBanner_Widget() );
        // }
    }
    ...
    public function widget_styles()
    {
        ...
        //wp_register_style( 'tf-slide-swiper', plugins_url( '/assets/css/slide-swiper/tf-slide-swiper.css', __FILE__ ) );
        ...
        //wp_register_style( 'tf-product-banner', plugins_url( '/assets/css/product-banner/tf-product-banner.css', __FILE__ ) );
        wp_register_style('tf-iconbox', plugins_url('/assets/css/iconbox/tf-iconbox.css', __FILE__));
        wp_register_style('tf-progress-bar', plugins_url('/assets/css/progress-bar/tf-progress-bar.css', __FILE__));
        wp_register_style('tf-navmenu', plugins_url('/assets/css/navmenu/tf-navmenu.css', __FILE__));
        //wp_register_style( 'tf-step', plugins_url( '/assets/css/step/tf-step.css', __FILE__ ) );
        //wp_register_style( 'tf-video', plugins_url( '/assets/css/video/tf-video.css', __FILE__ ) );
        //wp_register_style( 'tf-raindrop', plugins_url( '/assets/css/raindrop/tf-raindrop.css', __FILE__ ) );  

        if (is_rtl()) {
            wp_style_add_data('tf-team', 'rtl', 'replace');
            wp_style_add_data('tf-testimonial', 'rtl', 'replace');
            wp_style_add_data('tf-posts', 'rtl', 'replace');
            //wp_style_add_data( 'tf-product-banner', 'rtl', 'replace' );
    ...
    public function widget_scripts()
    {
        ...
        wp_enqueue_script('masonry', plugins_url('/assets/js/masonry.pkgd.min.js', __FILE__), ['jquery'], false, true);

        //widget
        //wp_register_script( 'tf-slide-swiper', plugins_url( '/assets/js/slide-swiper/tf-slide-swiper.js', __FILE__ ), [ 'jquery' ], false, true );
    ...
    public function tf_header_footer_post_type()
    {
        $labels = array(
            ...
            'not_found'             => esc_html__('No Template found', 'themesflat-elementor'),
            'not_found_in_trash'    => esc_html__('No Template found in Trash', 'themesflat-elementor')
...
?>
    ...
    public static function get_template_id($type)
    {
        ...
        $tfhf_templates = ThemesFlat_Addon_For_Elementor_Carenow::instance()->get_posts_by_conditions('tf_header_footer', $option);
...
ThemesFlat_Addon_For_Elementor_Carenow::instance();
