...
?>
<header id="header-home2" class="header header-style1 <?php echo themesflat_get_opt_elementor('extra_classes_header'); ?>">
    <div class="top-bar">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4">
                    <div class="address-box">
                        <div><img src="images/home2/02.png" alt="" class=""></div>
                        <ul>
                ...
                <div class="col-md-4 col-sm-4">
                    <div id="logo2" class="logo2 center">
