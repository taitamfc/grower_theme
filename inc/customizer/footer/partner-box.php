...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
        ...
        array(
            'type'      => 'checkbox',
            'label'     => esc_html__('Partner Box ( OFF | ON )', 'grower'),
...
$wp_customize->add_control(
    new themesflat_MultiImages(
        ...
        'img_partner',
        array(
           'label'          => esc_html__( 'Upload Your Partner Image', 'grower' ),
           'type'           => 'multi-image',
           'section'        => 'section_partner_box',
           'priority'       => 2,
...
$wp_customize->add_control(
    'show_number_img_partner_desktop',
    array(
       'label'          => esc_html__( 'Show Number Image (Desktop)', 'grower' ),
       'type'           => 'number',
       'section'        => 'section_partner_box',
       'priority'       => 3,
       'active_callback' => function() use ( $wp_customize ) {
...
$wp_customize->add_control(
    'show_number_img_partner_tablet',
    array(
       'label'          => esc_html__( 'Show Number Image (Tablet)', 'grower' ),
       'type'           => 'number',
       'section'        => 'section_partner_box',
       'priority'       => 4,
       'active_callback' => function() use ( $wp_customize ) {
...
$wp_customize->add_control(
    'show_number_img_partner_mobile',
    array(
       'label'          => esc_html__( 'Show Number Image (Mobile)', 'grower' ),
       'type'           => 'number',
       'section'        => 'section_partner_box',
       'priority'       => 5,
       'active_callback' => function() use ( $wp_customize ) {
...
$wp_customize->add_control(
    'gap_img_partner',
    array(
       'label'          => esc_html__( 'Gap Image', 'grower' ),
       'type'           => 'number',
       'section'        => 'section_partner_box',
       'priority'       => 6,
       'active_callback' => function() use ( $wp_customize ) {
...
$wp_customize->add_control( new themesflat_BoxControls($wp_customize,
    'partner_box_controls',
    array(
        'label' => esc_html__( 'Partner Box Controls (px)', 'grower' ),
        'section' => 'section_partner_box',
        'type' => 'box-controls',
        'priority' => 7,
        'active_callback' => function() use ( $wp_customize ) {
...
$wp_customize->add_control( 
    new themesflat_ColorOverlay(
        ...
        'partner_box_background_color',
        array(
            'label'         => esc_html__('Partner Box Backgound', 'grower'),
            'section'       => 'section_partner_box',
            'priority'      => 8,
            'active_callback' => function() use ( $wp_customize ) {
                return 1 === $wp_customize->get_setting( 'show_partner' )->value();
