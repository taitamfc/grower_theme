...
$links = paginate_links( array(
	...
	'prev_text' => ( '<i class="grower-icon-chevron-left"></i>' ),
	'next_text' => ( '<i class="grower-icon-chevron-right"></i>' ),
) );
...
$next_link = get_next_posts_link( esc_html__( 'Next', 'grower' ) );
$prev_link = get_previous_posts_link( esc_html__( 'Previous', 'grower' ) );
$loadmore_text = apply_filters('themesflat/template/loadmore_text',esc_html__('Load More','grower'));
...
<?php if ( $themesflat_paging_style == 'pager' && ! ( empty( $next_link ) && empty( $prev_link ) ) ): ?>
	...
	<nav class="navigation paging-navigation pager <?php themesflat_esc_attr($themesflat_paging_for);?>" role="navigation">
...
<?php elseif ( $themesflat_paging_style == 'numeric' && ! empty( $numeric_links ) ): ?>
	...
	<nav class="navigation paging-navigation numeric <?php themesflat_esc_attr($themesflat_paging_for);?>" role="navigation">
		<div class="pagination loop-pagination">
...
<?php elseif ( $themesflat_paging_style == 'loadmore' && ! empty( $next_link ) ): ?>
	...
	<nav class="navigation paging-navigation loadmore <?php themesflat_esc_attr($themesflat_paging_for);?>" role="navigation">
...
<?php elseif ( ! empty( $links ) ): ?>
	...
	<nav class="navigation  paging-navigation pager-numeric <?php themesflat_esc_attr($themesflat_paging_for);?>" role="navigation">
		<div class="pagination loop-pagination">
