...
class TFTeam_Widget extends \Elementor\Widget_Base {
	...
	protected function render($instance = []) {
		...
		if ($settings['title'] != '') {
			$title = '<h3 class="title-team-box">'.$settings['title'].'</h3>';
		}
		...
		foreach ( $settings['social_icon_list'] as $index => $item ) {
			...
			$social .= '<a href="' . $item['link']['url'] . '" ' . $target . $nofollow . '>'.\Elementor\Addon_Elementor_Icon_manager_carenow::render_icon( $item['social_icon'] ).'</a>';
		}
		$social_html = '<span class="icon-team">'.$social.'</span>';
		...
		if ($settings['style'] == 'style2') {
			$image_html = sprintf( '<div class="image-team">
									<div class="inner-image img-team-box">%1$s %2$s</div>									
			...
			$image_html = sprintf( '<div class="image-team hover-team">
									<div class="inner-image">%1$s</div>									
								</div>', $image );

			$content = sprintf( '<div class="wrap-team team-box">
								%1$s
			...
			$image_html = sprintf( '<div class="image-team">
									<div class="img-team-box">%1$s</div>									
								</div>', $image );
