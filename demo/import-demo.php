...
function themesflat_import_files() {
    return array(
        array(
            ...
            'import_file_url'            => esc_url(THEMESFLAT_PROTOCOL.'://themesflat.com/growerwp/demo/content.xml'),
            'import_widget_file_url'     => esc_url(THEMESFLAT_PROTOCOL.'://themesflat.com/growerwp/demo/widgets.wie'),
            'import_customizer_file_url' => esc_url(THEMESFLAT_PROTOCOL.'://themesflat.com/growerwp/demo/options.dat'),
            'import_preview_image_url'   => esc_url(THEMESFLAT_LINK.'screenshot.png'),
            'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the MailChimp form.', 'grower' ),
            'preview_url'                => esc_url(THEMESFLAT_PROTOCOL.'://themesflat.com/growerwp/'),
        ),
    );
}
