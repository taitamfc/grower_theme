...
if (class_exists('WP_Customize_Control')) {
	...
	class themesflat_Typography extends WP_Customize_Control {
		...
		public function render_content() {
			$this->titles = array(
				'100'        => esc_html__( 'Thin 100', 'grower' ),
				'100italic'  => esc_html__( 'Thin 100 italic', 'grower' ),
				'200'        => esc_html__( 'Extra-light 200', 'grower' ),
				'200italic'  => esc_html__( 'Extra-light 200 italic', 'grower' ),
				'300'        => esc_html__( 'Light 300', 'grower' ),
				'300italic'  => esc_html__( 'Light 300 italic', 'grower' ),
				'400'        => esc_html__( 'Normal 400', 'grower' ),
				'400italic'  => esc_html__( 'Normal 400 italic', 'grower' ),
				'regular'    => esc_html__( 'Normal 400', 'grower' ),
				'italic'     => esc_html__( 'Normal 400 italic', 'grower' ),
				'500'        => esc_html__( 'Medium 500', 'grower' ),
				'500italic'  => esc_html__( 'Medium 500 italic', 'grower' ),
				'600'        => esc_html__( 'Semi-bold 600', 'grower' ),
				'600italic'  => esc_html__( 'Semi-bold 600 italic', 'grower' ),
				'700'        => esc_html__( 'Bold 700', 'grower' ),
				'700italic'  => esc_html__( 'Bold 700 italic', 'grower' ),
				'800'        => esc_html__( 'Extra-bold 800', 'grower' ),
				'800italic'  => esc_html__( 'Extra-bold 800 italic', 'grower' ),
				'900'        => esc_html__( 'Ultra-bold 900', 'grower' ),
				'900itallic' => esc_html__( 'Ultra-bold 900 italic', 'grower' )
			);

			$this->titles_subsets = array(
				"cyrillic-ext"  => esc_html__("Cyrillic Extended",'grower'),
			    "greek" 		=> esc_html__("Greek",'grower'),
			    "greek-ext"		=>	esc_html__("Greek Extended",'grower'),
			    "latin-ext"		=>	esc_html__("Latin Extended",'grower'),
			    "cyrillic"		=>	esc_html__("Cyrillic",'grower'),
			    "vietnamese"	=>	esc_html__("Vietnamese",'grower'),
			    "latin" 		=> esc_html__("Latin",'grower')
				);
			...
			<div class="themesflat-options-control-inputs">					
				...
				<div class="themesflat-options-control-chosen themesflat-typography-group typography-font">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php themesflat_esc_attr( $name ) ?>-family"><?php esc_html_e( 'Font Family', 'grower' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
						<select name="<?php themesflat_esc_attr( $name ) ?>[family]" id="<?php themesflat_esc_attr( $name ) ?>-family" class="select-choosen" >
							<optgroup label="<?php themesflat_esc_html( 'Theme default', 'grower' ) ?>">
								<option 
								data_variants='["regular"]'
								data_subsets='["latin"]'
								value="Sue Ellen Francisco" <?php selected('Sue Ellen Francisco', $values['family']) ?>>Sue Ellen Francisco</option>				
							</optgroup>
							<optgroup label="<?php themesflat_esc_html( 'Google Fonts', 'grower' ) ?>">
				...
				<div class="themesflat-options-control-chosen themesflat-typography-group typography-style">
					<div class="themesflat-options-control-title customize-control-title">
						<label><?php esc_html_e( 'Font Weight & Style', 'grower' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
						<label>
				...
				<?php if ( in_array( 'subsets', $this->fields ) ): ?>
					<div class="themesflat-options-control typography-subsets themesflat-options-control-switcher active">
						<div class="themesflat-options-control-title customize-control-title">
							<label><?php esc_html_e( 'Font subsets', 'grower' ) ?></label>
						</div>
						<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-size">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php themesflat_esc_attr( $name ) ?>-size"><?php esc_html_e( 'Font Size (px)', 'grower' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-line_height">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php themesflat_esc_attr( $name ) ?>-line_height"><?php esc_html_e( 'Line height ( ex: 25px or 1.8 or 150% )', 'grower' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-letter_spacing">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php themesflat_esc_attr( $name ) ?>-letter_spacing"><?php esc_html_e( 'Letter Spacing ( Value in px or em )', 'grower' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
						<input type="text" name="<?php themesflat_esc_attr( $name ) ?>[letter_spacing]" value="<?php themesflat_esc_attr( $values['letter_spacing'] ) ?>" id="<?php themesflat_esc_attr( $name ) ?>-letter_spacing" />
					</div>
				</div>
				<!-- /size -->
				<?php endif ?>				
				...
				<div class="themesflat-typography-group themesflat-options-control-color-picker typography-color">
					<div class="themesflat-options-control-title customize-control-title">
						<label><?php esc_html_e( 'Font Color', 'grower' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
